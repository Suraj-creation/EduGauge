...
def render_sidebar():
    with st.sidebar:
        ...
        # Define pages with emojis based on role
        pages = [
            ("🏠 Home", "Home"),
        ...
        # Extract display names for radio options
        ...
        # Render radio buttons for navigation
...
def main():
    ...
    # Admin Tools Page
        ...
        col1, col2, col3, col4 = st.columns(4)
        with col1:
            st.metric("Teachers", 3, delta="Static")  # Assuming 3 for demo
        with col2:
        ...
        if st.session_state["pd_activities"]:
            ...
            pd_data["teacher"] = st.session_state["username"]  # Simplified; real app would track per teacher
